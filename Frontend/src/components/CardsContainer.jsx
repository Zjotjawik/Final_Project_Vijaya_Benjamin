...
export  const CardsContainer = ({data}) => {
  ...
  return (
    <div className='cardslide-container py-4 px-4 justify-content-center'>
      {data.slice(0,5).map(({_id, picture, medicalUses, hindiName, englishName}) => <Card id={_id} picture={picture} englishName={englishName} hindiName={hindiName} medicalUses={medicalUses} />)}
      <div className="col">
